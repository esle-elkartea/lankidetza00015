...
public class ProvinciasController
    extends net.idtoki.adimde.controller.BaseProvinciasController
{
 private static final Logger logger = Logger.getLogger("net.idtoki.adimde.controller.ProvinciasController");
