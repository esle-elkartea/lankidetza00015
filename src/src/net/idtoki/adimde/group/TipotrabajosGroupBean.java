 ...
 */
public class TipotrabajosGroupBean
    extends net.idtoki.adimde.group.BaseTipotrabajosGroupBean
{
  public TipotrabajosGroupBean(){
        this.dbField = TipotrabajosPeer.IDTIPOTRABAJO;
