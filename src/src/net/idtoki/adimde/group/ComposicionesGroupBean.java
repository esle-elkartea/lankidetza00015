 ...
 */
public class ComposicionesGroupBean
    extends net.idtoki.adimde.group.BaseComposicionesGroupBean
{
  public ComposicionesGroupBean(){
        this.dbField = ComposicionesPeer.IDCOMPOSICION;
