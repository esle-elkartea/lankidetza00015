...
<xsl:output method="fo"/>
	...
	<xsl:template match="result">
		...
		<xsl:for-each select="./Tipotrabajos">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="center" padding-after="0.3cm" padding-before="0.3cm" border-style="solid" border-width="0.1mm" table-layout="fixed">		
							<fo:block>
								<xsl:value-of select="NombreTipotrabajosParsed"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" padding-after="0.3cm" padding-before="0.3cm" border-style="solid" border-width="0.1mm" table-layout="fixed">		
							<fo:block>
								<xsl:value-of select="DescripcionTipotrabajosParsed"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" padding-after="0.3cm" padding-before="0.3cm" border-style="solid" border-width="0.1mm" table-layout="fixed">		
							<fo:block>
								<xsl:value-of select="CosteTipotrabajosParsed"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			...
			<fo:table-body>
				<fo:table-row background-color="#c0c0c0">
					<fo:table-cell text-align="right" padding-right="0.5cm" border-style="solid" border-width="0.1mm" table-layout="fixed">
						<fo:block>		
							Nº de registros: <xsl:value-of select="count(./Tipotrabajos)"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>					
